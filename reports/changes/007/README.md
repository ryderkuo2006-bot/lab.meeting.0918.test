...
Calculate T / sequence length * 100.

- Added columns: `t_percent`.
- [Original commit](https://github.com/ryderkuo2006-bot/lab.meeting.0918.test/commit/876bde46d68fc5680fa4ee0aeec5dfaa2f8feee1) · [Code at this version](https://github.com/ryderkuo2006-bot/lab.meeting.0918.test/blob/876bde46d68fc5680fa4ee0aeec5dfaa2f8feee1/analysis/calculate_gc.R).
...
[Local artifact index](artifacts.csv) lists descriptions, sizes and SHA-256 values. The preserved files are under `work/gc_content/history/t_percent/`, excluded from Git. Original snapshots retain their original language and paths to preserve their hashes.
