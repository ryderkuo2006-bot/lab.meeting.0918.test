# 012: Longest repeated base run

[Back to change log](../../README.md)

## Request and code change

Find the longest consecutive run of the same base.

- Added columns: `longest_run_bp`.
- [Original commit](https://github.com/ryderkuo2006-bot/lab.meeting.0918.test/commit/c098156ceb8fe5214dd330c88aa349a334c8f888) · [Code at this version](https://github.com/ryderkuo2006-bot/lab.meeting.0918.test/blob/c098156ceb8fe5214dd330c88aa349a334c8f888/analysis/calculate_gc.R).
...
[Local artifact index](artifacts.csv) lists descriptions, sizes and SHA-256 values. The preserved files are under `work/gc_content/history/longest_run_bp/`, excluded from Git. Original snapshots retain their original language and paths to preserve their hashes.
